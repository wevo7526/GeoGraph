...
// The palette moved to lib/palette.ts so the front door can use these hues
// without importing this file — and with it `three` (~1.5 MB), which a
// STATIC Landing import would pull into the first paint.
//
// Re-exported verbatim so Explorer.tsx's legend imports are untouched. The
// swatches are re-exported but NOT imported: they are the legend's, not the
// canvas's, and importing them here would be an unused binding.
export {
  ACTOR_COLOR,
  TYPE_LABEL,
  RELATION_COLOR,
